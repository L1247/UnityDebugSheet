...
namespace UnityDebugSheet.Runtime.Core.Scripts
{
    ...
    #region Public Methods
        ...
        public int AddButton(
                string text ,            string subText   = null , Color? textColor = null ,  Color? subTextColor = null ,
        ...
        public int AddEnumMultiPicker(
                Enum         activeValue ,               string text ,           Color? textColor = null ,
        ...
        public int AddEnumPicker(
                Enum   activeValue ,      string text ,             Color?       textColor = null , Color? subTextColor = null ,
        ...
        public int AddLabel(
                string text ,                string subText = null , Color? textColor = null ,
        ...
        public int AddMultiPicker(
                IEnumerable<string> options , IEnumerable<int> activeOptionIndices , string text ,
        ...
        {
            return AddPageLinkButton<DebugPage>(text , subText , textColor , subTextColor , icon ,
                                                iconColor ,
                                                titleOverride , onLoad , priority);
        }

        public int AddPageLinkButton(
                Type pageType , string text , string subText = null , Color? textColor = null ,
                Color? subTextColor = null , Sprite icon = null , Color? iconColor = null , string titleOverride = null ,
                Action<DebugPageBase> onLoad = null , int priority = 0)
        {
            ...
            return AddPageLinkButton(pageType , textModel , iconModel , titleOverride , onLoad ,
                                     priority);
        }

        public int AddPageLinkButton<TPage>(
                string        text ,                string subText  = null , Color? textColor = null ,
                Color?        subTextColor = null , Sprite icon     = null , Color? iconColor = null , string titleOverride = null ,
        ...
        public int AddPageLinkButton(
                CellTextsModel textModel ,            CellIconModel     iconModel = null ,
        ...
        public int AddPageLinkButton(
                Type   pageType ,             CellTextsModel        textModel ,     CellIconModel iconModel = null ,
                string titleOverride = null , Action<DebugPageBase> onLoad = null , int           priority  = 0)
        {
            return AddPageLinkButton(pageType , null , textModel , iconModel , titleOverride ,
                                     onLoad , priority);
        }
        ...
        {
            return AddPageLinkButton(null , textModel , iconModel , titleOverride , onLoad ,
                                     priority);
        }

        public int AddPageLinkButton(
                Type   pageType ,             DebugPageBase prefab , string text , string subText = null ,
                Color? textColor     = null , Color? subTextColor = null , Sprite icon = null , Color? iconColor = null ,
                string titleOverride = null , Action<DebugPageBase> onLoad = null , int priority = 0)
        {
            var textModel = new CellTextsModel();
            ...
            iconModel.Sprite = icon;
            if (iconColor != null) iconModel.Color = iconColor.Value;
            return AddPageLinkButton(pageType , prefab , textModel , iconModel , titleOverride ,
                                     onLoad , priority);
        }

        public int AddPageLinkButton<TPage>(
                TPage         prefab ,              string text ,            string subText   = null , Color? textColor     = null ,
                Color?        subTextColor = null , Sprite icon     = null , Color? iconColor = null , string titleOverride = null ,
                Action<TPage> onLoad       = null , int    priority = 0) where TPage : DebugPageBase
        {
            var textModel = new CellTextsModel();
            ...
            iconModel.Sprite = icon;
            if (iconColor != null) iconModel.Color = iconColor.Value;
            return AddPageLinkButton(prefab , textModel , iconModel , titleOverride , onLoad ,
                                     priority);
        }

        public int AddPageLinkButton(
                Type          pageType ,         DebugPageBase prefab ,               CellTextsModel        textModel ,
        ...
        public int AddPageLinkButton<TPage>(
                TPage  prefab ,               CellTextsModel textModel ,     CellIconModel iconModel = null ,
                string titleOverride = null , Action<TPage>  onLoad = null , int           priority  = 0) where TPage : DebugPageBase
        {
            var useSubText       = textModel != null && !string.IsNullOrEmpty(textModel.SubText);
            var useIcon          = iconModel != null && iconModel.Sprite != null;
        ...
        public int AddPicker(
                IEnumerable<string> options ,                    int    activeOptionIndex , string text , Color? textColor = null ,
                Color?              subTextColor        = null , Sprite icon    = null ,    Color? iconColor = null ,
        ...
        public int AddPickerOption(
                bool   isOn ,                string text ,        string subText   = null , Color?       textColor = null ,
        ...
        public int AddSearchField(
                string         placeholder = null , Action<string> valueChanged = null ,
        ...
        public int AddSlider(
                float  value ,                float  minValue ,               float maxValue , string text , string subText = null ,
                Color? textColor     = null , Color? subTextColor    = null , Sprite icon = null , Color? iconColor = null ,
        ...
        public int AddSwitch(
                bool   value ,               string text ,        string subText   = null , Color?       textColor    = null ,
